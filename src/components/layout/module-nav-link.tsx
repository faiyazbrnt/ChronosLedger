...
export function ModuleNavLink({
  ...
  const className = compact
    ? `flex flex-col items-center justify-center min-h-[48px] min-w-[56px] px-2 py-1 rounded-xl text-xs font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 ${
        isActive ? activeClasses : inactiveClasses
      }`
    : `group flex items-center gap-3.5 px-3.5 py-2.5 text-sm font-medium rounded-xl transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 ${
        isActive ? activeClasses : inactiveClasses
      }`;
