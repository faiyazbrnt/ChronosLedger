    ...
    <form onSubmit={handleSave} className="space-y-8 animate-in fade-in duration-300 max-w-3xl">
      ...
      {successMessage && (
        <div
          role="status"
          aria-live="polite"
          className="p-3.5 rounded-xl text-xs sm:text-sm font-medium flex items-center gap-2.5 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20"
        >
